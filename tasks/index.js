...
task(
    ...
    .addOptionalParam("targetNetwork", "the target network to set as a trusted remote")
...
task(
    "setTrustedRemoteAptos",
    "setTrustedRemoteAptos",
    require("./setTrustedRemoteAptos")
)
    .addOptionalParam("targetNetwork", "the target network to set as a trusted remote")
    .addOptionalParam("localContract", "Name of local contract if the names are different")
    .addOptionalParam("remoteContract", "Name of remote contract if the names are different")
...
task("setMinDstGasLookup", "estimateSendMultiFee", require("./setMinDstGasLookup"))
    ...
    .addOptionalParam("gas", "the contract to delete and redeploy")
